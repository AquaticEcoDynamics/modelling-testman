...
<!--   <source src="images/03-module2/video2.mp4" type="video/mp4"> -->
<!--   <p>Test</p> -->
<!-- </video> -->
<!-- </center> -->
...
![Video 1: Match your Excel equations to the formulas on the sheet (Tip: Make this video fullscreen for better viewing).](images/03-module2/video1.mp4){width=100%}
...
![Step 1: Enter the inputs for Iron. Don't forget to 'run' these!](images/03-module2/video2.mp4){width=100%}

</center>
<br>
<center>

![Step 2: Write the equation. It should match Equation \@ref(eq:module2-4).](images/03-module2/video3.mp4){width=100%}

</center>
<br>
<center>

![Step 3: Graph it and repeat previous steps for the other oxidants.](images/03-module2/video4.mp4){width=100%}
